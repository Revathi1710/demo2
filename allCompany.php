                        ...
                        if (mysqli_num_rows($employee) > 0) {
                            ...
                            while ($item = mysqli_fetch_assoc($employee)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="next-follow">
                                            <small><i class="fas fa-calendar"></i><?= $item['nextfollow_date']; ?></small>
                                            <small class="text-muted"><i class="fas fa-clock"></i><?= $item['nextfollow_time']; ?></small>
                                        </div>
                                    </td>
                                    <td>
