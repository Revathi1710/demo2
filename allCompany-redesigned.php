...
<head>
    ...
    <title>Company Management - Professional Dashboard</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="main-container" id="mainContainer">
        ...
        <div class="data-card">
            <div class="table-header">
                <h3 class="table-title">Company Directory</h3>
            </div>
                                    ...
                                    <td>
                                        <?php if ($item['action'] == ''): ?>
                                            <span class="status-badge status-not-open">
                                                <i class="fas fa-clock me-1"></i>Not Open
                                            </span>
                                        <?php else: ?>
                                            <?php if ($item['action'] == 'NI'): ?>
                                                <span class="status-badge status-ni">
                                                    <i class="fas fa-times-circle me-1"></i><?= $item['action']; ?>
                                                </span>
                                            <?php else: ?>
                                                <span class="status-badge status-success">
                                                    <i class="fas fa-check-circle me-1"></i><?= $item['action']; ?>
                                                </span>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="action-dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-modern">
                                                <li>
                                                    <a class="dropdown-item-modern" href="viewCompany.php?id=<?= $item['id']; ?>">
                                                        <i class="fas fa-eye me-2"></i>View Details
                                                    </a>
                                                </li>
                                                <li>
                                                    <button class="dropdown-item-modern" data-bs-toggle="modal" data-bs-target="#actionModal<?= $item['id']; ?>">
                                                        <i class="fas fa-edit me-2"></i>Take Action
                                                    </button>
                                                </li>
                                                <li>
                                                    <button class="dropdown-item-modern" data-bs-toggle="modal" data-bs-target="#HiringModal<?= $item['id']; ?>">
                                                        <i class="fas fa-handshake me-2"></i>Hiring Candidate
                                                    </button>
                                                </li>
                                                <li>
                                                    <button class="dropdown-item-modern" data-bs-toggle="modal" data-bs-target="#historyModal<?= $item['id']; ?>">
                                                ...
                                                <?php if($isAdmin == 1) { ?>
                                                <li>
                                                    <a class="dropdown-item-modern danger" href="deleteCompany.php?id=<?= $item['id']; ?>">
