                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <small><i class="fas fa-calendar me-1"></i><?= $item['nextfollow_date'] ?: 'Not Set'; ?></small>
                                            <small class="text-muted"><i class="fas fa-clock me-1"></i><?= $item['nextfollow_time'] ?: 'Not Set'; ?></small>
                                        </div>
                                    </td>
                                    <td>
